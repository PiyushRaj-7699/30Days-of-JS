...
//Activity 1: Arithmetic operator
  ...
  let x = 55;
  let y = 5; 
  console.log("x + y =", x + y) ;   //OUTPUT : x + y = 60
  ...
  x = 60;
  y = 50;
  console.log("x * y =" , x*y) ;     //output : x * y = 3000
  ...
  x = 67;
  y = 33;
  console.log("Remainder of x and y =" , x%y) ;  //output :Remainder of x and y = 1

//Activity 2: ASSIGNMENT OPERATION....

 //Task 6: Use the += operator to add a number to variable and log the result to console.

 let a= 15;   // a+=b indicates a= a+b.
 a += 55;
 console.log("Addition Assignment : a+=55 , a=", a) ;   //OUTPUT :Addition Assignment : a+=55 , a= 70  
